                                            ...
                                            <div class="qp_contents_all perinfor_pagem">
                                                ...
                                                <div class="personal_inf_contents_main">
                                                    <div class="pi_content_single">
                                                        <label for="">Age</label>
                                                        <input v-model="input.age" type="text" placeholder="Enter Age">
                                                    </div>
                                                    <div class="pi_content_single">
                                                    ...
                                                    <div class="pi_content_single">
                                                        ...
                                                        <input v-model="input.currentWeight" type="text" placeholder="Enter Weight">
                                                        <div class="pi_content_single_text">
                                                            <p>lbs</p>
                                                        </div>
                                                    </div>
                                                    <div class="pi_content_single">
                                                        ...
                                                        <input v-model="input.desiredWeightGoal" type="text" placeholder="Enter Weight">
                                                        <div class="pi_content_single_text">
                                                            <p>lbs</p>
                                                        </div>
                                                    </div>
