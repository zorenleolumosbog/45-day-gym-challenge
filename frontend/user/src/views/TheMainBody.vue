                            ...
                            <div class="right_site_time_remaining_main">
                                ...
                                <div class="right_site_upload_photo">
                                    ...
                                    <div class="rsup_items_all">
                                        <div class="rsup_item_single">
                                            ...
                                            <div class="rsup_item_single_upload">
                                                <p>Upload Your <span>Front Photo</span></p>
                                                <div class="cnasfu_upload">
                                                    <input @change="handleFileFrontPhotoAttachment" type="file" id="file" accept="image/png, image/gif, image/jpeg">
                                        ...
                                        <div class="rsup_item_single">
                                            ...
                                            <div class="rsup_item_single_upload">
                                                ...
                                                <div class="cnasfu_upload">
                                                    <input @change="handleFileSidePhotoAttachment" type="file" id="file2" accept="image/png, image/gif, image/jpeg">
                                        ...
                                        <div class="rsup_item_single">
                                            ...
                                            <div class="rsup_item_single_upload">
                                                ...
                                                <div class="cnasfu_upload">
                                                    <input @change="handleFileBackPhotoAttachment" type="file" id="file3" accept="image/png, image/gif, image/jpeg">
                                ...
                                <div class="right_site_remaining_bottom_contents">
                                    ...
                                    <div class="rsrbc_form">
                                        <div v-if="validation.success.message" class="mt-4 mb-4 alert alert-success alert-dismissible fade show" role="alert">
                                        ...
                                        <div class="rsrbc_form_box">
                                            <label for="rsrtc2">Wirte Notes</label>
